...
public class Visor {
	...
	/*
	 * No se incluye constructor de la clase puesto que como la clase no tiene
	 * atributos, en principio no es necesario inicializar nada
	 */

	/*
	 * Muestra un mensaje de bienvenida En principio, no hace falta parametro:
	 * se puede poner un mensaje fijo Se puede añadir parametro si se desea
	 */
	...
	/*
	 * Muestra un mensaje de despedida En principio, no hace falta parametro: se
	 * puede poner un mensaje fijo Se puede añadir parametro si se desea
	 */
	...
	/*
	 * Se añade este metodo que no esta en el diagrama por si es necesario
	 * utilizarlo en algun momento (¿para depurar?)
	 * 
