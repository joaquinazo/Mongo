...
public class Dispensador {
	...
	/*
	 * Atributos de la clase String nombreProducto - No esta en el diagrama pero
	 * lo añado para poder identificar el producto (coca, fanta, sprite,...)
	 * int cantidad - numero de latas de un producto que se encuentran en la
	 * maquina en un determinado momento int precio - precio que cuesta el
	 * producto (en centimos)
	 */
	private int id;
	 ...
	 * 
	 * @param inicial - cantidad inicial de productos El constructor no recibe
	 * el clasificador, se asigna posteriormente
	 */
	...
	/*
	 * toString para comprobar el estado del dispensador
	 * 
	 * @return retorna un string con los datos del dispensador
	 */
	public String toString() {
		String s = "";
		s += "El dispensador de " + nombreProducto + " contiene " + cantidad + " latas que cuestan " + precio
				+ " centimos\n";
		return s;
	}
