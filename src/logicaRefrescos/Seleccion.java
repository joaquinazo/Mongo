...
public class Seleccion extends Tecla {
	...
	/*
	 * Cada tecla selecci�n tiene el clasificador asociado al que lanza el
	 * mensaje "seleccionar" cuando la tecla de selecci�n es pulsada
	 */
	...
	/*
	 * cuando se pulsa la tecla de seleccion de un producto se lanza el mensaje
	 * seleccionar al dispensador recordamos que cada boton esta asociado con un
	 * unico dispensador
	 */
