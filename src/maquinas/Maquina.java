...
public class Maquina {
	...
	public Maquina(HashMap<Integer, Deposito> hmDepositos, HashMap<String, Dispensador> hmDispensadores) {
		// Creamos clasificador (le pasamos como parametro los depositos y los
		// dispensadores)
		clasificador = new Clasificador(hmDepositos, hmDispensadores);
		// Creamos tecla retorno (le pasamos el clasificador para que lo tenga
		// enlazado)
		teclaRetorno = new Retorno(clasificador);
		// Creamos los botones de seleccion (uno por cada producto)
		// Recorremos hashmap de dispensadores para obtener el nombre del
		// producto
		Seleccion nuevoSel;
	...
	/*
	 * Metodo finalizarMaquina Guarda los datos de los dispensadores y depositos
	 * (si se puede) Se llama a este metodo cuando se elige la opcion salir
	 */
