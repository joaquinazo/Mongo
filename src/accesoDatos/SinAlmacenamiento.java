...
public class SinAlmacenamiento implements Datos {
	...
	/*
	 * En este caso se crean los objetos en el propio c�digo, no se leen los
	 * datos de ning�n lado Los datos, no ser�n persistentes
	 */
	...
	public HashMap<Integer, Deposito> obtenerDepositos() {
		...
		for (int i = 2; i < 8; i++) {
			...
			// Una vez creado el deposito con valor de la moneda y cantidad lo
