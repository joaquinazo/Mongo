...
public class Controlador {
	...
	// Cuando se llame a este método es que se ha finalizado la ejecucian de la
	// maquina
	...
	/*
	 * METODOS PARA LLAMADAS DESDE EL INTERFAZ "Intermediario" entre interfaz y
	 * Maquina
	 */
	...
	public void seleccionarProducto(String op) {
		...
		if (ok && maquinaRefrescos.getClasificador().getSaldo() > 0) { // Si se
																		// ha
																		// servido
																		// la
																		// lata
