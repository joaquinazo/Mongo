...
public class Grafico extends Generico implements ActionListener {
	 ...
	 * seleccionarProducto Atributos propios ventana : para el JFrame
	 */
	...
	public Grafico() {
		...
		// Añadimos un listener para controlar el cierre de la ventana (hay que
	...
	/*
	 * Metodo para mostrar posibles productos a seleccionar (lo hacemos con
	 * botones)
	 */
	...
	public void actionPerformed(ActionEvent e) {
		...
		// Dependiendo de la primera parte del nombre del boton sabemos si han
		// pulsado moneda, producto o retorno
		...
		// JOptionPane.showMessageDialog(source, nombreBoton + " button has been
		// pressed");
